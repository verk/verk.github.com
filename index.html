...
<head>
    ...
    <title></title>
    <meta name="description" content="Verk ApS open source page">
    ...
    <link rel="stylesheet" href="/styles/960.css?v=1">
...
<body>
    ...
    <script>!window.jQuery && document.write('<script src="/scripts/jquery-1.4.2.min.js"><\/script>')</script>


    <script src="/scripts/mustache.js?v=1"></script>
    ...
    <script>
        var _gaq = [['_setAccount', 'UA-116454-26'], ['_trackPageview']];
        (function(d, t) {
